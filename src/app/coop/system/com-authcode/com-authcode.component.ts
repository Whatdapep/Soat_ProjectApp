...
@Component({
  selector: 'app-com-authcode',
  templateUrl: './com-authcode.component.html',
  styleUrls: ['./com-authcode.component.scss'],
})
export class ComAuthcodeComponent implements OnInit {
